    ...
    return (
      <div className="checkoutComponent">
        <div className="orderDetails">
          ...
          <div>
            <h5>Items :</h5>
            {Object.keys(this.state.order.items).map((key) => {
              return (
                <div key={key} className="item">
                  ...
                  <h6>
                    &#8377;&nbsp;
                    {parseFloat(
                      parseFloat(this.state.order.items[key].price) *
                        parseFloat(this.state.order.items[key].qty)
                    ).toFixed(2)}
                  </h6>
                </div>
              );
            ...
            <div className="orderPrice">
              ...
              <h5>
                &#8377;&nbsp;
                {parseFloat(
                  parseFloat(this.state.order.tax.cgst) +
                    parseFloat(this.state.order.tax.sgst)
                ).toFixed(2)}
              </h5>
            </div>
            <div className="orderPrice">
